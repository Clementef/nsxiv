...
static const int CACHE_SIZE_MEM_PERCENTAGE =
    0;                                 /* use 3% of total memory for cache */
static const int CACHE_SIZE_LIMIT = 0; /* but not above 256MiB */
static const int CACHE_SIZE_FALLBACK =
    0; /* fallback to 32MiB if we can't determine total memory */

// static const int CACHE_SIZE_MEM_PERCENTAGE = 3;          /* use 3% of total
// memory for cache */ static const int CACHE_SIZE_LIMIT = 256 * 1024 * 1024; /*
// but not above 256MiB */ static const int CACHE_SIZE_FALLBACK = 32 * 1024 *
// 1024; /* fallback to 32MiB if we can't determine total memory */
