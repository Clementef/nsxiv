...
static const char *WIN_BG[]   = { "Nsxiv.window.background",   "#282a36" };
static const char *WIN_FG[]   = { "Nsxiv.window.foreground",   "#f8f8f2" };
...
static const char *BAR_FONT[] = { "Nsxiv.bar.font",            "FiraCode Nerd Font" };
...
static const keymap_t keys[] = {
	...
	/* zoom */
	{ 0,            XK_s,             i_fit_to_win,         SCALE_FILL },
	{ 0,            XK_a,             i_fit_to_win,         SCALE_FIT },
	{ 0,            XK_equal,         g_zoom,               +1 },
	{ 0,            XK_KP_Equal,      g_zoom,               +1 },
	{ 0,            XK_minus,         g_zoom,               -1 },
	{ 0,            XK_KP_Subtract,   g_zoom,               -1 },
	{ 0,            XK_0,		  i_set_zoom,           100 },
	...
	/* antialias and alpha */
	{ 0,            XK_w,             i_toggle_antialias,   None },
	{ 0,            XK_W,             i_toggle_alpha,       None },
